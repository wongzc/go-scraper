...
func main() {
	...
	for {
		...
		fmt.Println("Type in a search term:")
		fmt.Scan(&searchTerm)
		// fmt.Println("Type in a country code (default: \"com\"):")
		...
		// 	countryCode = "com"
		// }
		// fmt.Println("Type in a language (default: \"en\"):")
		// reader = bufio.NewReader(os.Stdin)
		...
		// 	languageCode = "en"
		// }
		// fmt.Printf("Please confirm. search term: %s, country code: %s, language: %s \n", searchTerm, countryCode, languageCode)
